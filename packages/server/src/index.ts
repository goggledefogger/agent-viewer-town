...
// Fallback middleware to enforce 403 Forbidden for unauthorized origins.
// The cors() middleware only omits headers for rejected origins but continues execution.
