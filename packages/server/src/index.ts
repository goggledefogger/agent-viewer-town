...
// Explicit fallback middleware to actively reject unauthorized origins
// Since cors() returning false only omits CORS headers rather than blocking the request
