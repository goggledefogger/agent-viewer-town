...
// Explicit 403 fallback middleware for unauthorized origins
// The cors middleware returns `callback(null, false)` which omits CORS headers but doesn't block simple requests.
