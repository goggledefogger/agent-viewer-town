...
// Explicit fallback middleware to return 403 Forbidden for disallowed origins.
// The `cors` middleware returning `false` only omits CORS headers, allowing simple requests.
