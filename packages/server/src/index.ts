...
// Fallback middleware to explicitly return 403 for disallowed origins
// because cors() with callback(null, false) just omits headers and doesn't block simple requests.
