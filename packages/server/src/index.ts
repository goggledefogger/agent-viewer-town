...
// Fallback middleware to explicitly reject unauthorized origins with a 403 Forbidden.
// The cors middleware only omits the CORS headers, it does not block the request itself.
