...
export function validateToken(token?: string): boolean {
  ...
  // Use SHA-256 to hash both the token and serverToken before comparing.
  // This ensures they have the same length for timingSafeEqual and prevents
  // timing attacks that could reveal the length or content of the token.
