...
export function validateToken(token?: string): boolean {
  ...
  // Hash both tokens to ensure they are the same length before constant-time comparison
  // This prevents length-extension attacks and issues with timingSafeEqual requiring same length
